...
namespace AppRpgEtec.Services
{
    public class Request
    {
        ...
        public async Task<TResult> PostAsync<TResult>(string uri, TResult data, string token) //Método Post
        {
            HttpClient httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization
            = new AuthenticationHeaderValue("Bearer", token);
        ...
        public async Task<int> PutAsync<TResult>(string uri, TResult data, string token) //Método Put
        {
            HttpClient httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization
            = new AuthenticationHeaderValue("Bearer", token);
        ...
        public async Task<int> DeleteAsync(string uri, string token) //Método Delete
        {
            HttpClient httpClient = new HttpClient();
